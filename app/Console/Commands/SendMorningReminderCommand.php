...
{
    protected $signature = 'app:send-morning-reminders {--dry-run : Run without sending actual WhatsApp messages} {--day= : Override day name, e.g. monday} {--ignore-holiday : Run reminders even if today is a holiday}';
    ...
    public function handle(ReminderService $reminderService): int
    {
        ...
        $results = $reminderService->sendMorningReminders($dryRun, $customDay, $ignoreHoliday);
